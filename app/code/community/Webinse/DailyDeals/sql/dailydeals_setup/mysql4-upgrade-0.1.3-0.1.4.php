...
$installer->addAttribute($entityTypeId, 'old_special_price', array(
    'type' => 'varchar',
    'backend' => '',
    'frontend' => '',
...
$installer->addAttribute($entityTypeId, 'old_special_date_from', array(
    'type' => 'datetime',
    'backend' => '',
    'frontend' => '',
...
$installer->addAttribute($entityTypeId, 'old_special_date_to', array(
    'type' => 'datetime',
    'backend' => '',
    'frontend' => '',
